...
public class MiniumCPContentListEntryRenderer
	...
	public void render(
		...
		dependencies.add(
			"commerce-frontend-taglib@2.1.9/js/add_to_cart/AddToCartButton.es");
		dependencies.add(
			"commerce-frontend-taglib@2.1.9/js/compare_checkbox" +
				"/CompareCheckbox.es");
		dependencies.add("commerce-frontend-taglib@2.1.9/js/price/Price.es");
